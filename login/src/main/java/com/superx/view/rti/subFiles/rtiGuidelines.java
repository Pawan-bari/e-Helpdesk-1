...
public class rtiGuidelines {
    ...
    public VBox createGuidelinesCard() {
        ...
        TitledPane guidelinesPane = createSchemeCategory("RTI & Grievance Guidelines",
                createLink("RTI Guide Book (PDF)",
                        "https://www.letindiadevelop.org/wp-content/uploads/2021/05/RTI-guide-book.pdf"),
                createLink("Public Grievance Manual (PDF)",
                        "https://sachet.bih.nic.in/Manuals/Grievance_Redressal_Mechanism.pdf"),
                createLink("Citizen Charter Guidelines (PDF)",
                        "https://yojana.gov.in/Citizen%20Charter%20Guidelines.pdf"));
