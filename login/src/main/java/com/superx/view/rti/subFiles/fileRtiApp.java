...
public class fileRtiApp {
    ...
    public VBox createRTIApplicationCard() {
        ...
        TitledPane rtiForms = createSchemeCategory("RTI Application Forms",
                createLink("Central Government RTI Form", "https://rtionline.gov.in/request/guidelines.php?request"),
                createLink("RTI Application Format (PDF)",
                        "https://rtionline.gov.in/documents/Format_of_Application_for_Seeking_Information.pdf"));

        TitledPane filingInstructions = createSchemeCategory("How to File RTI",
                createLink("Step-by-step RTI Filing Guide",
                        "https://nhrc.nic.in/sites/default/files/RTI%20Application%20Guidelines.pdf"),
                createLink("RTI for State Government",
                        "https://dpar.karnataka.gov.in/storage/pdf-files/RTI/RTI_English_Guide.pdf"));
        ...
        TitledPane stateRTI = createSchemeCategory("State RTI Forms",
                createLink("Maharashtra RTI Form (PDF)", "https://rti.maharashtra.gov.in/images/pdf/form_a.pdf"),
                createLink("Tamil Nadu RTI Form",
                        "https://www.tn.gov.in/tamilnadustate_information_commission/rti-form-a.pdf"),
                createLink("Uttar Pradesh RTI Form", "http://information.up.nic.in/Rti_Form_A.pdf"),
                createLink("Karnataka RTI Application Form",
                        "https://dpar.karnataka.gov.in/storage/pdf-files/RTI/rti%20application%20form.pdf"),
                createLink("Delhi RTI Application Form", "https://services.india.gov.in/forms/delhi-rti-form.pdf"),
                createLink("Gujarat RTI Application Form",
                        "https://rti.gujarat.gov.in/images/pdf/rti_application_form.pdf"));
