...
public class RtiPage {
    ...
    // Updated method signature to include navigation callbacks for RTI sub-pages
    public BorderPane rtiPageBox(Runnable showProfileScreen, Runnable showLoginScreen, Runnable showlegal,
        ...
        // SIDEBAR SECTION
        VBox sidebar = createSidebar(showProfileScreen, showlegal, showdoc, showland, showarchive, shownotificatio2);

        // MAIN CONTENT SECTION - Now passing RTI navigation callbacks
        VBox mainContent = createMainContent(showProfileScreen, showLoginScreen, showlegal, showdoc,
                showFileRti, showGuidelines, showGrievance);
    ...
    private VBox createSidebar(Runnable showProfileScreen, Runnable showlegal, Runnable showdoc, Runnable showland,
            Runnable showarchive, Runnable shownotificatio2) {
        ...
        // Navigation Buttons
        VBox navButtons = createNavigationButtons(showlegal, showdoc, showland, showarchive, shownotificatio2);
    ...
    // Updated method signature to include RTI navigation callbacks
    private VBox createMainContent(Runnable showProfileScreen, Runnable showLoginScreen, Runnable showlegal,
            Runnable showdoc, Runnable showFileRti, Runnable showGuidelines, Runnable showGrievance) {
