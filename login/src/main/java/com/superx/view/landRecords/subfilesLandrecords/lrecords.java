...
public class lrecords {
    ...
    public VBox createLandRecordSearchCard() {
        ...
        TitledPane karnatakaPane = createSchemeCategory("Karnataka",
                createLink("Bhoomi Online RTC", "https://landrecords.karnataka.gov.in/service2/"),
        ...
        TitledPane telanganaPane = createSchemeCategory("Telangana",
                ...
                createLink("Web Land Records", "https://webland.telangana.gov.in/"));
        ...
        TitledPane rajasthanPane = createSchemeCategory("Rajasthan",
                createLink("Apna Khata Rajasthan", "http://apnakhata.raj.nic.in/"),
                createLink("E-Dharti Rajasthan", "http://apnakhata.raj.nic.in/"));

        TitledPane tamilnaduPane = createSchemeCategory("Tamil Nadu",
                createLink("TN Patta Chitta", "https://eservices.tn.gov.in/"),
                createLink("Village Land Records", "https://eservices.tn.gov.in/"));

        TitledPane biharPane = createSchemeCategory("Bihar",
                createLink("Bihar Bhumi", "https://biharbhumi.bihar.gov.in/"),
                createLink("Land Records Online", "https://biharbhumi.bihar.gov.in/"));
