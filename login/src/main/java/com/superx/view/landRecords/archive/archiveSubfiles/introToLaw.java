...
public class introToLaw {
    ...
    public VBox createIntroToLawCard() {
        ...
        TitledPane basicsPane = createSchemeCategory("Understanding Indian Laws",
                createLink("Indian Constitution (Bare Act PDF)",
                        "https://legislative.gov.in/sites/default/files/COI_1.pdf"),
                createLink("Basic Rights & Duties (NCERT PDF)", "https://ncert.nic.in/textbook/pdf/jess301.pdf"));

        // Category 2: Types of Laws
        TitledPane categoryPane = createSchemeCategory("Types of Laws",
                createLink("Criminal Law (IPC Basics PDF)",
                        "https://www.indiacode.nic.in/bitstream/123456789/4214/1/A1860-45.pdf"),
                createLink("Civil Procedure Code (CPC PDF)",
                        "https://www.indiacode.nic.in/bitstream/123456789/2239/1/A1908-05.pdf"),
                createLink("Consumer Protection Act (2019 PDF)",
                        "https://consumeraffairs.nic.in/sites/default/files/CPA-2019.pdf"));

        // Category 3: Important Acts
        TitledPane keyActsPane = createSchemeCategory("Key Acts and Guides",
                createLink("RTI Act Manual (English PDF)", "https://rti.gov.in/RTICorner/RTI_Manual_English.pdf"),
                createLink("Legal Rights of Women (NCW PDF)",
                        "https://ncw.nic.in/sites/default/files/Legal%20Rights%20of%20Women.pdf"),
                createLink("Information Technology Act (IT Act PDF)",
                        "https://www.meity.gov.in/writereaddata/files/itact2000.pdf"));
