...
public class courtProcedures {
    ...
    public VBox createCourtProceduresCard() {
        ...
        TitledPane structurePane = createSchemeCategory("Structure of Indian Judiciary",
                createLink("Introduction to Indian Judiciary",
                        "https://districts.ecourts.gov.in/sites/default/files/Intro%20to%20Indian%20Judiciary.pdf"),
                createLink("Hierarchy of Courts in India",
                        "https://main.sci.gov.in/pdf/importantLinks/Hierarchy%20of%20Courts.pdf"));

        // Section 2: Filing & Trial Process
        TitledPane filingPane = createSchemeCategory("Filing and Trial Process",
                createLink("How to File a Case in Civil Court",
                        "https://districts.ecourts.gov.in/sites/default/files/Filing%20Civil%20Case.pdf"),
                createLink("Criminal Case Procedure",
                        "https://districts.ecourts.gov.in/sites/default/files/Criminal%20Case%20Flow.pdf"));

        // Section 3: E-Court Services & Guidelines
        TitledPane eCourtPane = createSchemeCategory("E-Courts & Legal Services",
                createLink("eCourts User Manual",
                        "https://ecourts.gov.in/ecourts_home/static/manuals/eCourtsUserManual.pdf"),
                createLink("Legal Aid Guidelines (NALSA)",
                        "https://nalsa.gov.in/sites/default/files/document/NALSA-LegalAidGuidelines.pdf"));
