...
public class rightRespons {
    ...
    public VBox createLegalRightsCard() {
        ...
        TitledPane rightsPane = createSchemeCategory("Fundamental Rights & Duties",
                createLink("Fundamental Rights (Constitution of India)",
                        "https://legislative.gov.in/sites/default/files/COI_1.pdf"),
                createLink("Duties of Indian Citizens (NCERT PDF)", "https://ncert.nic.in/textbook/pdf/jess301.pdf"));

        // Section 2: Legal Rights in Daily Life
        TitledPane dailyRightsPane = createSchemeCategory("Legal Rights in Daily Life",
                createLink("Legal Rights of Women (NCW Booklet)",
                        "https://ncw.nic.in/sites/default/files/Legal%20Rights%20of%20Women.pdf"),
                createLink("Consumer Rights Handbook (CPA 2019)",
                        "https://consumeraffairs.nic.in/sites/default/files/CPA-2019.pdf"),
                createLink("Right to Education (RTE Act)",
                        "https://legislative.gov.in/sites/default/files/A2009-35.pdf"));
        ...
        TitledPane grievancePane = createSchemeCategory("Grievance and Protection",
                ...
                createLink("Protection of Children from Sexual Offences (POCSO Act)",
                        "https://wcd.nic.in/sites/default/files/POCSO%20Act%2C%202012.pdf"),
                createLink("Domestic Violence Act", "https://wcd.nic.in/sites/default/files/violence.pdf"));
