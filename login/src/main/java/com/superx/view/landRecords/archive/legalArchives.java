...
public class legalArchives {
    ...
    // Updated method signature with navigation callbacks
    public BorderPane legalbox(Runnable showProfileScreen, Runnable showLoginScreen, Runnable showlegal,
        ...
        navBtn2.setOnMouseEntered(event -> navBtn2
                .setStyle("-fx-padding: 12px 15px; -fx-background-radius: 10px; -fx-background-color: #eef2ff;"));
        navBtn2.setOnMouseExited(event -> navBtn2
                .setStyle("-fx-padding: 12px 15px; -fx-background-radius: 10px; -fx-background-color: transparent;"));
        ...
        navBtn3.setOnMouseExited(event -> navBtn3
                .setStyle("-fx-padding: 12px 15px; -fx-background-radius: 10px; -fx-background-color: transparent;"));
        navBtn3.setOnMouseClicked(evt -> showland.run());
        ...
        searchField.setStyle(
                "-fx-font-size: 14px; -fx-background-radius: 8px; -fx-border-radius: 8px; -fx-border-color: #a0b3d7; -fx-padding: 12px;");
        searchField.setPrefWidth(400);

        Button searchButton = new Button("Search");
        searchButton.setFont(Font.font("Inter", FontWeight.SEMI_BOLD, 14));
        searchButton.setStyle(
                "-fx-background-color: #3b82f6; -fx-background-radius: 8px; -fx-text-fill: white; -fx-padding: 10px 25px;");
        searchButton.setCursor(Cursor.HAND);
        searchButton.setOnMouseEntered(event -> searchButton.setStyle(
                "-fx-background-color: #2563eb; -fx-background-radius: 8px; -fx-text-fill: white; -fx-padding: 10px 25px;"));
        ...
        // INTRODUCTION TO LAW CARD (Constitutional Law)
        VBox constitutionalCard = new VBox(15);
        constitutionalCard.setStyle(
                "-fx-background-color: rgba(255, 255, 255, 0.8); -fx-border-color: #a0b3d7; -fx-border-style: solid; -fx-border-width: 1.5; -fx-border-radius: 15; -fx-background-radius: 15;");
        ...
        Label constTitle = new Label("Introduction to Law");
        ...
        Label topic1 = new Label("• Indian Constitution (Bare Act PDF)");
        Label topic2 = new Label("• Basic Rights & Duties (NCERT PDF)");
        Label topic3 = new Label("• Criminal Law (IPC Basics PDF)");
        Label topic4 = new Label("• Consumer Protection Act");
        ...
        constitutionalCard.setOnMouseEntered(e -> constitutionalCard.setStyle(
                "-fx-background-color: rgba(255, 255, 255, 0.95); -fx-border-color: #3b82f6; -fx-border-style: solid; -fx-border-width: 2; -fx-border-radius: 15; -fx-background-radius: 15; -fx-effect: dropshadow(gaussian, rgba(0,0,0,0.2), 15, 0, 0, 5);"));
        constitutionalCard.setOnMouseExited(e -> constitutionalCard.setStyle(
                "-fx-background-color: rgba(255, 255, 255, 0.8); -fx-border-color: #a0b3d7; -fx-border-style: solid; -fx-border-width: 1.5; -fx-border-radius: 15; -fx-background-radius: 15;"));

        // Add click handler to navigate to Introduction to Law
        constitutionalCard.setOnMouseClicked(e -> showIntroToLaw.run());

        // COURT PROCEDURES CARD (Civil Law)
        ...
        Label civilTitle = new Label("Court Procedures");
        ...
        Label civilDesc = new Label(
                "Understand court procedures, filing cases, trial process and legal documentation required for various court proceedings.");
        ...
        Label civiltopic1 = new Label("• Structure of Indian Judiciary");
        Label civiltopic2 = new Label("• Filing and Trial Process");
        Label civiltopic3 = new Label("• E-Courts & Legal Services");
        Label civiltopic4 = new Label("• Legal Aid Guidelines");
        ...
        civilCard.setOnMouseEntered(e -> civilCard.setStyle(
                "-fx-background-color: rgba(255, 255, 255, 0.95); -fx-border-color: #3b82f6; -fx-border-style: solid; -fx-border-width: 2; -fx-border-radius: 15; -fx-background-radius: 15; -fx-effect: dropshadow(gaussian, rgba(0,0,0,0.2), 15, 0, 0, 5);"));
        civilCard.setOnMouseExited(e -> civilCard.setStyle(
                "-fx-background-color: rgba(255, 255, 255, 0.8); -fx-border-color: #a0b3d7; -fx-border-style: solid; -fx-border-width: 1.5; -fx-border-radius: 15; -fx-background-radius: 15;"));

        // Add click handler to navigate to Court Procedures
        civilCard.setOnMouseClicked(e -> showCourtProcedures.run());

        // RIGHTS & RESPONSIBILITIES CARD (Criminal Law)
        VBox criminalCard = new VBox(15);
        criminalCard.setStyle(
                "-fx-background-color: rgba(255, 255, 255, 0.8); -fx-border-color: #a0b3d7; -fx-border-style: solid; -fx-border-width: 1.5; -fx-border-radius: 15; -fx-background-radius: 15;");
        ...
        Label criminalTitle = new Label("Rights & Responsibilities");
        ...
        Label criminalDesc = new Label(
                "Learn about your legal rights, fundamental duties, and responsibilities as a citizen. Understanding protection mechanisms.");
        ...
        Label criminaltopic1 = new Label("• Fundamental Rights & Duties");
        Label criminaltopic2 = new Label("• Legal Rights in Daily Life");
        Label criminaltopic3 = new Label("• Grievance and Protection");
        Label criminaltopic4 = new Label("• RTI Act Manual");
        ...
        criminalCard.setOnMouseEntered(e -> criminalCard.setStyle(
                "-fx-background-color: rgba(255, 255, 255, 0.95); -fx-border-color: #3b82f6; -fx-border-style: solid; -fx-border-width: 2; -fx-border-radius: 15; -fx-background-radius: 15; -fx-effect: dropshadow(gaussian, rgba(0,0,0,0.2), 15, 0, 0, 5);"));
        criminalCard.setOnMouseExited(e -> criminalCard.setStyle(
                "-fx-background-color: rgba(255, 255, 255, 0.8); -fx-border-color: #a0b3d7; -fx-border-style: solid; -fx-border-width: 1.5; -fx-border-radius: 15; -fx-background-radius: 15;"));

        // Add click handler to navigate to Rights & Responsibilities
        criminalCard.setOnMouseClicked(e -> showRightRespons.run());

        // CORPORATE LAW CARD (Keep as is or make clickable if needed)
        VBox corporateCard = new VBox(15);
        corporateCard.setStyle(
                "-fx-background-color: rgba(255, 255, 255, 0.8); -fx-border-color: #a0b3d7; -fx-border-style: solid; -fx-border-width: 1.5; -fx-border-radius: 15; -fx-background-radius: 15;");
        ...
        Label corporateDesc = new Label(
                "Understanding company formation, corporate governance, mergers, acquisitions and business regulations.");
        ...
        corporateCard.setOnMouseEntered(e -> corporateCard.setStyle(
                "-fx-background-color: rgba(255, 255, 255, 0.95); -fx-border-color: #3b82f6; -fx-border-style: solid; -fx-border-width: 2; -fx-border-radius: 15; -fx-background-radius: 15; -fx-effect: dropshadow(gaussian, rgba(0,0,0,0.2), 15, 0, 0, 5);"));
        corporateCard.setOnMouseExited(e -> corporateCard.setStyle(
                "-fx-background-color: rgba(255, 255, 255, 0.8); -fx-border-color: #a0b3d7; -fx-border-style: solid; -fx-border-width: 1.5; -fx-border-radius: 15; -fx-background-radius: 15;"));
        ...
        Label a1 = new Label(
                "A: Visit the nearest police station with all relevant details. The police officer is legally bound to register your FIR under Section 154 of CrPC.");
        ...
        Label a2 = new Label(
                "A: Property registration requires stamp duty payment, document verification, and registration at the Sub-Registrar office within 4 months of execution.");
        ...
        Label a3 = new Label(
                "A: File an application under Section 438 CrPC in Sessions Court or High Court through a lawyer, stating reasonable grounds for fear of arrest.");
        ...
        assistanceSection.setStyle(
                "-fx-background-color: rgba(59, 130, 246, 0.1); -fx-background-radius: 12px; -fx-padding: 25px; -fx-border-color: #3b82f6; -fx-border-width: 1px; -fx-border-radius: 12px;");
        ...
        Label assistanceDesc = new Label(
                "Get connected with legal aid services, pro bono lawyers, and legal consultation services in your area.");
        ...
        findLawyerBtn.setOnMouseEntered(e -> findLawyerBtn.setStyle(
                "-fx-background-color: #2563eb; -fx-text-fill: white; -fx-background-radius: 8px; -fx-padding: 10px 20px;"));
        findLawyerBtn.setOnMouseExited(e -> findLawyerBtn.setStyle(
                "-fx-background-color: #3b82f6; -fx-text-fill: white; -fx-background-radius: 8px; -fx-padding: 10px 20px;"));

        Button legalAidBtn = new Button("Legal Aid Services");
        legalAidBtn.setFont(Font.font("Inter", FontWeight.BOLD, 14));
        legalAidBtn.setStyle(
                "-fx-background-color: transparent; -fx-text-fill: #3b82f6; -fx-border-color: #3b82f6; -fx-border-width: 2px; -fx-background-radius: 8px; -fx-border-radius: 8px; -fx-padding: 10px 20px;");
        legalAidBtn.setCursor(Cursor.HAND);
        legalAidBtn.setOnMouseEntered(e -> legalAidBtn.setStyle(
                "-fx-background-color: #3b82f6; -fx-text-fill: white; -fx-border-color: #3b82f6; -fx-border-width: 2px; -fx-background-radius: 8px; -fx-border-radius: 8px; -fx-padding: 10px 20px;"));
        legalAidBtn.setOnMouseExited(e -> legalAidBtn.setStyle(
                "-fx-background-color: transparent; -fx-text-fill: #3b82f6; -fx-border-color: #3b82f6; -fx-border-width: 2px; -fx-background-radius: 8px; -fx-border-radius: 8px; -fx-padding: 10px 20px;"));
