...
public class ProfilePage {
    ...
    public BorderPane profilebox(Runnable showAccountScreen, Runnable showSecurityScreen, Runnable showDocScene, Runnable showNotification, Runnable showStorage) {
        ...
        emailField.setStyle("-fx-font-size: 14px; -fx-background-color: #e0e7ff; -fx-border-radius: 8px; -fx-padding: 8px;");
    ...
    private void uploadProfilePicture(File file) {
        ...
        try {
            ...
            storageClient.bucket().create(blobName, Files.readAllBytes(file.toPath()), Files.probeContentType(file.toPath()));
